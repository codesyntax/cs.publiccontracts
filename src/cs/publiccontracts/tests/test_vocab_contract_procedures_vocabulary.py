...
class ContractProceduresVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_contract_procedures_vocabulary(self):
        vocab_name = "cs.publiccontracts.ContractProceduresVocabulary"
