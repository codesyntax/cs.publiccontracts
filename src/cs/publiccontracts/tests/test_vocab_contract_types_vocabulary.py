...
class ContractTypesVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_contract_types_vocabulary(self):
        vocab_name = "cs.publiccontracts.ContractTypesVocabulary"
